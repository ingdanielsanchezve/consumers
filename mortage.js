...
(function(){
    ...
    function showResults(element, value, isMobile){

        if (isMobile) {
            document.getElementById(element).className = "results_value_display_mobile";
            if (element == "mortage_value_mobile"){ 
                document.getElementById(element).style.fontSize = "18px"
                document.getElementById(element).style.marginTop = "19px"
            }
            animatePanel();
        }else{
            document.getElementById(element).className = "results_value_display";
            if (element == "mortage_value")
    ...
    calcMortageBtn.addEventListener("click", calculateMortage);
